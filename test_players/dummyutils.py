        ...
        for i in range(7):
                for j in range(7):
                        if new.getCellValue((i,j)) == -1 and origin.getCellValue((i,j)) == 0:
                                return (i, j)
                        elif new.getCellValue((i,j)) == 0 and origin.getCellValue((i,j)) == 1:
                                (a,b)=(i,j)
...
# def find_backup_trap(origin):
        ...
        #                         return (i,j)
        if len(new.get_neighbors((a,b), True))>0:
            for i,j in new.get_neighbors((a,b), True):
                    return (i,j)
        # if len(origin.get_neighbors(player, True))>0:
        #     for i,j in origin.get_neighbors(player, True):
        #             return (i,j)
        for i in range(7):
                for j in range(7):
                        if origin.getCellValue((i,j))==0:
